...
const CCLogo = ({className} : Props) => {
  return (
    <svg className={className} width="399" height="108" viewBox="0 0 399 108" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <ellipse cx="197.453" cy="67.5383" rx="6.23895" ry="7.8429" transform="rotate(70.9017 197.453 67.5383)" fill="#EE8191"/>
      <path d="M199 38C199 36.3431 200.343 35 202 35C203.657 35 205 36.3431 205 38V67H199V38Z" fill="#EE8191"/>
    </svg>
  )
}
